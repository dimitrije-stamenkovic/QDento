...
ContextMenu::ContextMenu()
{
    ...
    QString otherActionNames[otherInputsCount]
    {
        ...
        tr("Restoration DO"), 
        tr("Restoration MOD"),
        tr("Remove")/*Restoration*/,
        tr("Remove")/*Caries*/, 
        tr("Remove Status"),
        tr("Remove Bridge / Splint")
    };
  ...
  //  addAction(menuAction[Dental::Dsn]);
    ...
    QMenu* obturMenu = statusMenu->addMenu(tr("Restoration"));
    QMenu* defObturMenu = statusMenu->addMenu(tr("Defect Restoration"));
    QMenu* cariesMenu = statusMenu->addMenu(tr("Caries"));
    QMenu* nonCariesMenu = statusMenu->addMenu(tr("Non-Caries Lesion"));
    ...
    auto endoMenu = statusMenu->addMenu(tr("Endodontics"));
    ...
    auto surgeryMenu = statusMenu->addMenu(tr("Surgery"));
    ...
    dsnMenuAction->setText(tr("Supernumeral Tooth"));

    auto perioMenu = statusMenu->addMenu(tr("Periodontology"));
    ...
    auto prosthoMenu = statusMenu->addMenu(tr("Prosthodontics"));
...
void ContextMenu::setPresenter(VisitPresenter* presenter) { 
